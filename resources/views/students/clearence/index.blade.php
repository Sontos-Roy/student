            ...
            <div id="kt_app_content_container" class="app-container  container-xxl "
                ...
                <div class="card" data-select2-id="select2-data-134-m6wh">
                    <div class="card-body py-4">
                        <form id="ajax_form"
                            class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('students.clearence.store')}}" method="POST">
                            @csrf
                            <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                ...
                                @if ($program->title == 'BBA' || $program->title == 'CSE')
                                    <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                @else
                                    <input type="hidden" name="internship_title" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="N/A">
                                @endif
                                <div class="fv-row mb-7 fv-plugins-icon-container">
