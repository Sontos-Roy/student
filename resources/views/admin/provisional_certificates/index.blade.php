                    ...
                    <div class="card-header border-0 pt-6" data-select2-id="select2-data-133-65s4">
                        ...
                        <div class="card-toolbar" data-select2-id="select2-data-132-ib8y">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{route('admin.provisional.certificates.create')}}" class="btn btn-primary">
                                    <i class="ki-duotone ki-plus fs-2"></i> Add Certificate
                                </a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('admin.provisional.certificates.show', $item->id)}}" class="menu-link px-3">
                                                            View
                                                        </a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                            <form action="{{ route('admin.provisional.certificates.destroy', $item->id) }}" method="POST" class="delete_form" id="delete{{$item->id}}">
                                                            @csrf
                                                            @method('DELETE')
