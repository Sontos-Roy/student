                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="">
                                    <thead>
                                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px">CGPA</th>
                                            <th class="min-w-125px">Exam Date</th>
                                    ...
                                    <tbody class="text-gray-600 fw-semibold">
                                        ...
                                        <tr class="{{$key+1 / 2 ? 'even' : 'odd'}}">
                                            ...
                                            <td>
                                                @if ($item->defense_semester_status == 1)
                                                <div class="badge badge-success fw-bold">Accepted</div>
                                                @else
                                                <div class="badge badge-danger fw-bold">Denied</div>
                                                @endif
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('admin.programs.edit', $item->id)}}" class="menu-link px-3 modal_btn">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                            <form action="{{ route('admin.programs.destroy', $item->id) }}" method="POST" class="delete_form" id="delete{{$item->id}}">
                                                            @csrf
                                                            @method('DELETE')
