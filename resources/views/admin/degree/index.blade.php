                        ...
                        <div class="card-toolbar" data-select2-id="select2-data-132-ib8y">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <i class="ki-duotone ki-plus fs-2"></i> Add Dgree
                                </button>
                            </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="">
                                    <thead>
                                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px">Accept Faculty</th>
                                            <th class="min-w-125px">Accept Department</th>
                                            <th class="min-w-125px">Roles For Approve Clearance</th>
                                    ...
                                    <tbody class="text-gray-600 fw-semibold">
                                        ...
                                        <tr class="{{$key+1 / 2 ? 'even' : 'odd'}}">
                                            ...
                                            <td>
                                                @if ($item->accept_faculty == 1)
                                                <div class="badge badge-success fw-bold">Accepted</div>
                                                @else
                                                <div class="badge badge-danger fw-bold">Denied</div>
                                                @endif
                                            </td>
                                            <td>
                                                @if ($item->accept_department == 1)
                                                <div class="badge badge-success fw-bold">Accepted</div>
                                                @else
                                                <div class="badge badge-danger fw-bold">Denied</div>
                                                @endif
                                            ...
                                            <td>
                                                @foreach ($item->approverRoles as $role)
                                                <div class="badge badge-info fw-bold">{{ $role->name }}</div>
                                                @endforeach
                                            </td>
                                            <td class="text-end">
                                                <a href="#"
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('admin.degree.edit', $item->id)}}" class="menu-link px-3 modal_btn">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                            <form action="{{ route('admin.degree.destroy', $item->id) }}" method="POST" class="delete_form" id="delete{{$item->id}}">
                                                            @csrf
                                                            @method('DELETE')
