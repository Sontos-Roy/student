                        ...
                        <div class="card-toolbar" data-select2-id="select2-data-132-ib8y">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <i class="ki-duotone ki-plus fs-2"></i> Add Clearance
                                </button>
                            </div>
                            @include('admin.clearance.add')
                        </div>
                    </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="">
                                    <thead>
                                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px">Approvers</th>
                                    ...
                                    <tbody class="text-gray-600 fw-semibold">
                                        ...
                                        <tr class="{{$key+1 / 2 ? 'even' : 'odd'}}">
                                            ...
                                            <td>
                                                {{$item->faculty ? $item->faculty->title : 'N/A'}}
                                            </td>
                                            <td>
                                                {{$item->department ? $item->department->name : 'N/A'}}
                                            </td>
                                            <td>
                                                {{$item->degree ? $item->degree->name : 'N/A'}}
                                            </td>
                                            <td>
                                                {{$item->program ? $item->program->title : 'N/A'}}
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('admin.clearance.show', $item->id)}}" class="menu-link px-3">
                                                            View
                                                        </a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('admin.clearance.edit', $item->id)}}" class="menu-link px-3 modal_btn">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                            <form action="{{ route('admin.clearance.destroy', $item->id) }}" method="POST" class="delete_form" id="delete{{$item->id}}">
                                                            @csrf
                                                            @method('DELETE')
