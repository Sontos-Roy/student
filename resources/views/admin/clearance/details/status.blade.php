                    ...
                    <div class="card d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px w-xxl-400px">
                        <div class="card-body px-6 px-lg-10 px-xxl-15 py-20">
                            <div class="stepper-nav">
                                @foreach ($clearence->clearanceApprovers as $key => $item)
                                <div class="stepper-item {{$item->status == 1 ? 'current' : ''}}" data-kt-stepper-element="nav">
                                    <div class="stepper-wrapper">
                                        <div class="stepper-icon w-40px h-40px {{$item->status ==  1 ? 'bg-success text-light' : ''}}">
                                        ...
                                        <div class="stepper-label">
                                            ...
                                            <div class="stepper-desc fw-semibold">
                                                @if ($item->status == 1)
                                                <div class="text-success">Successfully Approved Clearance From {{$item->approverRole->name}}</div>
                                                @else
                                                Waiting For Approved Clearance From {{$item->approverRole->name}}
                                                @endif
                                            </div>
                                        </div>
                                    </div>
